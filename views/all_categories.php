...
<table>
    ...
    <?php while ($row = $searchStmt->fetch()) {
        ...
        <tr>
            ...
            <td><a href="/mezabi-1?controller=Categories&action=goEditCategorie&code_categorie=<?php echo $code ?>&categorie=<?php echo $designation ?>">Modifier la catégorie</a></td>
        </tr>
    <?php } ?>
</table>
